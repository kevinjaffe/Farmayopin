...
class _AdminMainState extends State<AdminMain> {
    ...
    switch (indice) {
      case 1:
        return KeyedSubtree(
          ...
          child: AdminHistorial(usuario: widget.usuario),
        );
      case 2:
        return KeyedSubtree(
          key: const ValueKey<int>(2),
          child: AdminPerfil(usuario: widget.usuario),
        );
      default:
        return KeyedSubtree(
          key: const ValueKey<int>(0),
          child: AdminProductos(usuario: widget.usuario),
        );
    }
  }
  ...
  Animation<Offset> _offsetTransicion(
    ...
    if (!entrante) {
      // La página saliente queda quieta: la nueva se desliza por encima.
